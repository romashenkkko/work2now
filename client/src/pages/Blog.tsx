...
const POSTS = [
  { date: "15 Ianuarie 2026", title: "Cum sa iti creezi un profil atractiv pe Time2Go", desc: "Sfaturi practice pentru a-ti optimiza profilul si a atrage mai multe oferte de joburi. Afla ce fac angajatorii sa te aleaga.", icon: "📝" },
  ...
  { date: "5 Ianuarie 2026", title: "Time2Go se extinde in Romania", desc: "Anuntam lansarea platformei in Romania. Afla cum poti beneficia de serviciile noastre in noul market.", icon: "🚀" },
  { date: "28 Decembrie 2025", title: "Plata rapida: cum functioneaza", desc: "Explicam procesul de plata rapida pe Time2Go si de ce primesti salariul in maxim 48 de ore dupa finalizarea jobului.", icon: "💰" },
  { date: "20 Decembrie 2025", title: "Aplicatia mobila Time2Go", desc: "Descopera functiile aplicatiei mobile: gestionare joburi, notificari, plata si multe altele.", icon: "📱" },
  { date: "15 Decembrie 2025", title: "Sfaturi pentru angajatori", desc: "Cum sa scrii anunturi eficiente si sa gasesti personalul potrivit rapid pe Time2Go.", icon: "⭐" },
];
