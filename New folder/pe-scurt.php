  ...
  <body>
    ...
    <main class="section cta">
      <div class="container">
        <h2>Pe scurt</h2>
        <p>
          Work2Now conecteaza angajatori cu persoane care cauta joburi flexibile,
          ofera un proces digital rapid si asigura plata prompta dupa fiecare sarcina.
        </p>
        <div class="cta-actions">
          <a class="btn btn-primary" href="find-jobs.php">Vezi joburi</a>
          <a class="btn btn-secondary" href="contact.php">Scrie-ne</a>
        </div>
      </div>
    </main>
